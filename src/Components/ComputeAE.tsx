            ...
            buttonClick={() => {
                ...
                setTimeout(() => {
                    try {
                        ...
                        const ds_len = chartData[0].data.length;
                        const ds_periods = chartData[0].data.map((item: any) => Number(item.x));
                        const ds = chartData[0].data.map((item: any) => Number(item.y));
                        ...
                        const new_chartdata = [ chartData[0], 
                        {
                        ...
                        enqueueSnackbar("Calculate artificial acceleration graph data is successfully", {
                            variant: "success",
