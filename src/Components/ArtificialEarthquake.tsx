...
import ComputeDS_1 from './1_ComputeDS';
...
const ArtificalEarthquake = (props: any) => {
    ...
    return (
        <GuideBox width="100%" spacing={0.5}>
            ...
            <Panel variant="strock" width="100%" padding={0} border="1px solid #ddd">
            ...
            <GuideBox width="100%" row horSpaceBetween spacing={1} padding={1}>
                <Button color='negative' onClick={() => setOpen(true)}>Calc. Design Spectrum</Button>
                {
                    design_spectrum === 1 &&
                    // eslint-disable-next-line react/jsx-pascal-case
                    <ComputeDS_1 open={open} setOpen={setOpen} design_spectrum={design_spectrum} />
                }
