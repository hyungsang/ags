...
const App = () => {
	...
	return (
		<GuideBox width={1000} height={820} center padding={2} overflow="visible">
			<GuideBox center spacing={2}>
				<GuideBox row spacing={2}>					
					<Panel variant="shadow2" padding={2}>						
						<GuideBox width={400} height={360} spacing={2} verTop>
							<CompTypographyAndDropList title="Design Spectrum" state={design_spectrum} setState={setDesignSpectrum} blueTitle droplist={design_spectrum_list} width={250}/>
							<DesignSpectrum />
						</GuideBox>
					</Panel>

					<Panel variant="shadow2" padding={2}>
						<GuideBox width={400} height={360} verSpaceBetween>
						 	<ArtificalEarthquake />
						</GuideBox>
					</Panel>
				...
				<GuideBox width="100%" row horSpaceBetween>
					<Panel variant="shadow2" padding={2}>
						<GuideBox width={850} height={350} verSpaceBetween>	
							<CompCharGraph />			
						</GuideBox>
					</Panel>
				</GuideBox>
